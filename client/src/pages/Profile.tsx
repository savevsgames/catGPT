      ...
      {modal.type === "password" ? (
        <>
          ...
          <div className="flex justify-end space-x-4">
            <button onClick={() => setModal({ type: "", isOpen: false })} className=" m-1 px-4 py-2 bg-color_3 rounded-lg hover:bg-color_5 transition-colors">
              Cancel
            </button>
            <button onClick={handlePasswordChange} className="m-1 px-4 py-2 bg-color_3 rounded-lg hover:bg-color_5 transition-colors">
              Save
            </button>
          </div>
        </>
        ...
        <>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button onClick={handleUsernameChange} className="m-1 px-4 py-2 bg-color_3 rounded-lg hover:bg-color_5 transition-colors">
              Save
            </button>
          </div>
        </>
        ...
        <>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button onClick={handleBioChange} className="m-1 px-4 py-2 bg-color_3 rounded-lg hover:bg-color_5 transition-colors">
              Save
            </button>
          </div>
        </>
      ...
      {successModal.isOpen && (
        <div className="fixed inset-0 flex justify-center items-center">
          <div className="bg-color_2 p-6 rounded-lg shadow-lg max-w-md border-2 border-color_3 justify-items-center">
            ...
            <button onClick={() => setSuccessModal({ isOpen: false, message: "" })} className="mt-3 m-2 px-4 py-2 bg-color_3 text-white rounded-lg">Close</button>
          </div>
        </div>
      )}
    </div>

            ...
            <div className="md:flex md:space-x-6">
                ...
                <div className="w-full md:w-2/3">
                    <div className="p-6 rounded-lg shadow-lg mb-6">
                        <h1 className="text-2xl font-semibold mb-2">{mockData.username}</h1>
                        <p><strong>Bio:</strong> {mockData.bio}</p>
                    </div>
                    <div className="space-x-0 space-y-4 md:space-y-0 md:space-x-4">
                        <button onClick={handleChangePassword} className="py-2 px-4 rounded hover:bg-red-300 w-full md:w-auto">
                            Change Password</button>
                        <button onClick={handleChangeBio} className="py-2 px-4 rounded hover:bg-red-300 w-full md:w-auto">
                            Change Bio</button>
                        <button onClick={handleChangeUsername} className="py-2 px-4 rounded hover:bg-red-300 w-full md:w-auto">
